...
rich Text
	Ansi chart
		...
		if as_ansi:
			console = Console(legacy_windows=True,force_terminal=True,color_system='standard',width=sizeX+20,height=sizeY+20)
...
rich Text
	Ansi chart
		...
		if as_ansi:
			console = Console(legacy_windows=True,force_terminal=True,color_system='standard',width=sizeX+20,height=1)
			with console.capture() as capture:
				console.print(ret)
			ret = capture.get()
		return ret
...
rich Text
	Ansi chart
		...
		if as_ansi:
			console = Console(legacy_windows=True,force_terminal=True,color_system='standard',width=sizeX+10,height=1)
			with console.capture() as capture:
				console.print(ret)
			ret = capture.get()
		return ret
